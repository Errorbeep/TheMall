					...
					<table id="example1" class="table table-bordered table-striped">
						...
						<tr>
							...
							<td width="60px"><a
								...
								<br>
								<c:if test="${p.state == 1}">
									<a href="${pageContext.request.contextPath}/PruductUpdateStateServlet?id=${p.id}&newState=2" >下架</a>
								</c:if>
								<c:if test="${p.state == 2}">
									<a href="${pageContext.request.contextPath}/PruductUpdateStateServlet?id=${p.id}&newState=1" >上架</a>
								</c:if>
								<a href="${pageContext.request.contextPath}/PruductUpdateStateServlet?id=${p.id}&newState=0" >删除</a>
							</td>
						</tr>
